...
/* We customize this class for easiler process in Collectra 
 */
namespace Coat\ktbs\Lib;
use  Coat\Ktbs\Lib\Rdfapi-php\Api\constants;
use  Coat\Ktbs\Lib\Rdfapi-php\Api\util\Object;
use  Coat\Ktbs\Lib\Rdfapi-php\Api\util\RdfUtil;
use   Coat\Ktbs\Lib\Rdfapi-php\Api\Syntax\RdfParser;
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">';
	...
	/*
	 * triples2array function return a simplied array of triples for multi-purposes in Collectra
	 */
	function string2statements($rdf, $base){
		$this->string2triples($rdf, $base);
